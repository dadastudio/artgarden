...
<nav class="xl:h-42 relative z-10 flex h-16 items-center gap-x-6 border-b border-gray-200 max-lg:grid max-lg:grid-cols-2 md:h-28 md:justify-between md:px-8">
